...
df_ID=df_ID[["Site ID","Lon","Lat","Vertical Rate (mm/yr)","Vertical Rate - BOP corrected (mm/yr)","1-sigma uncertainty (mm/yr)","Number of obs","Quality Factor","Average distance between coastal point and observations"]]
print(df_ID.head())
